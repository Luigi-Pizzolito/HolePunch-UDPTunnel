...
replace github.com/Luigi-Pizzolito/HolePunch-UDPTunnel/tunnelman => ./tunnelman
...
require (
	...
	github.com/Luigi-Pizzolito/HolePunch-UDPTunnel/tunnelman v0.0.0-00010101000000-000000000000
